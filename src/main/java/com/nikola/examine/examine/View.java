...
public class View extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View frame = new View(new FaceMainFrame(), "1047", "007");
	 ...
	 * Create the frame.
	 */
	public View(FaceMainFrame ffame,String userId, String userName) {
		this.fframe=ffame;
		this.userId = userId;
		...
		lblNewLabel_1.setBounds(10, 0, 177, 60);
		...
		lblNewLabel_12.setBounds(500, 0, 280, 60);
		...
		lblNewLabel_2.setBounds(900, 0, 150, 60);
		...
		//设置按钮的位置和大小
		btnNewButton_start.setBounds(1060, 10, 100, 40);
		//在容器中添加按钮
		...
		//设置按钮的位置和大小
		btnNewButton_submit.setBounds(1170, 10, 100, 40);
		//在容器中添加按钮
		...
		//设置面板容器的位置和大小
		panel_question.setBounds(0, 60, 1266, 290);
		//添加问题的面板容器
		...
		//设置新问题的大小
		lblNewLabel_question.setBounds(0, 0, 1266, 290);
		//设置新问题文本的相对位置
		...
		panel_answer.setBounds(0, 350, 1266, 360);
		...
		lblNewLabel_answer.setBounds(10, 0, 1256, 360);
		//添加回答到回答的面包那容器中
		panel_answer.add(lblNewLabel_answer);

		//新建面板容器panel_3并设置面板容器
		JPanel panel_3 = new JPanel();
		panel_3.setBackground(new Color(180,180,180));
		panel_3.setBounds(0, 715, 1266, 272);
		...
		btnNewButton_next.setBounds(1095, 187, 161, 50);

		//添加下一题按钮到panel_3的面板容器中
		...
		btnNewButton_6.setBounds(385, 180, 65, 65);
		...
		btnNewButton_7.setBounds(460, 180, 65, 65);
		...
		btnNewButton_8.setBounds(534, 180, 65, 65);
		...
		btnNewButton_9.setBounds(609, 180, 65, 65);
		...
		btnNewButton_10.setBounds(684, 180, 65, 65);
		...
		btnNewButton_previous.setBounds(845, 187, 161, 50);
		panel_3.add(btnNewButton_previous);

		//添加A、B、C、D按钮，并设置按钮A、B、C、D
		...
		lblNewLabel_A.setBounds(200, 45, 120, 100);
		...
		lblNewLabel_B.setBounds(440, 45, 120, 100);
		...
		lblNewLabel_C.setBounds(660, 45, 120, 100);
		...
		lblNewLabel_D.setBounds(880, 45, 120, 100);
	...
	public void registerListeners(JLabel lblNewLabel_1, JLabel lblNewLabel_2, JLabel lblNewLabel_question,
		...
		AnswerQuestionListener answerQuestionListener = new AnswerQuestionListener(lblNewLabel_answer,
				...
				lblNewLabel_B, lblNewLabel_C, lblNewLabel_D);
